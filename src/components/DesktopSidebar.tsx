...
export default function DesktopSidebar() {
  ...
  return (
    <motion.aside
      animate={{
        x: (isHidden || (isMobile && !isHovered && isHidden)) ? -SIDEBAR_WIDTH : 0,
      ...
      className={`fixed left-0 top-0 bottom-0 z-50 flex flex-col p-4 overflow-hidden ${isMobile && isHidden ? 'pointer-events-none' : ''} ${!isMobile ? 'hidden lg:flex' : ''}`}
